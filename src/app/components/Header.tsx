    ...
    <header className={styles.header}>
      <div className={styles.nav}>
        ...
        <div className={styles.left}>
          <Image src="/images/logo.png" alt="Facebook" width={160} height={40} />
        ...
        <div className={styles.center}>
          <div className={`${styles.navIcon} ${styles.active}`}>
          <svg
          viewBox="0 0 24 24"
          width="24"
          height="24"
        ...
        <div className={styles.right}>
          ...
          <svg viewBox="0 0 24 24" width="20" height="20" fill="currentColor" className="xfx01vb x1lliihq x1tzjh5l x1k90msu x2h7rmj x1qfuztq" style={{ color: "var(--primary-icon)" }}
          aria-hidden="true">
        ...
        >
          ...
          <div className={styles.circleIcon} >
            <Image src="/images/notification.png" alt="notification" width={20} height={20} />
          </div>
          <div className={styles.circleIcon} style={{padding:'0'}}>
            <Image src="/images/profile-pic.png.jpg" alt="profile" width={40} height={40} style={{borderRadius:'50%'}}/>
          </div>
        </div>
      </div>
    </header>
